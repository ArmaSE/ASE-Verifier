...
function prepare_db() {
    ...
    let query_list = [
        ...
        'CREATE TABLE IF NOT EXISTS logs (log_id INTEGER PRIMARY KEY AUTOINCREMENT, severity VARCHAR(1), action VARCHAR(128), category VARCHAR(32), timestamp VARCHAR(64));',
        ...
        `INSERT INTO settings VALUES ('bot_activity_name', ' ', 1);`,
        ...
        `INSERT INTO settings VALUES ('bot_guest_role_id', ' ', 1);`,
    ...
    inq.prompt(l1).then(answer => {
        switch(answer.main_menu) {
            ...
            case 4:
                ...
                break;
            case 5:
                console.log('Exited ASE Verificator preparation tool!');
                process.exit(0);
                break;
            default:
                tool_menu();
